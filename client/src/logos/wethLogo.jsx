export default function wethLogo({width}) {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height="" version="1.1" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd"
